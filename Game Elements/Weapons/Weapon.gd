...
@export var attack_script: Resource = preload("res://Game Elements/Attacks/smash.gd")
@export var attack_scene: String = "res://Game Elements/Attacks/smash.tscn"
var attack : Attack

static func create_weapon(weapon_resource : String):
	var weapon = load(weapon_resource)
	weapon.attack = Attack.create_from_resource(weapon.attack_scene,weapon.attack_script)
	return weapon
